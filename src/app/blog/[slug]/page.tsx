  ...
  const renderBlogContent = () => {
    switch (slug) {
      ...
      case "unraveling-the-mysteries-of-manglik-dosh-and-its-influence-on-each-zodiac-sign":
        ...
        <h1 className="text-4xl font-bold text-center">Unraveling the Mysteries of Manglik Dosh and Its Influence on Each Zodiac Sign</h1>
        ...
        <article className="prose lg:prose-xl mx-auto">
          ...
          <section>
            ...
            <p><strong>[Your Name]</strong> is a seasoned astrologer with over a decade of experience in Vedic astrology. Passionate about helping individuals navigate their astrological paths, [Your Name] specializes in relationship astrology and spiritual guidance.</p>
          </section>
        </article>
      </div>
      ...
      case "how-many-guna-matching-is-needed-for-a-successful-marriage-a-comprehensive-guide":
          return (
            ...
            <div className="container mx-auto px-4 py-8">
              ...
              <h1>How Many Guna Matching is Needed for a Successful Marriage? A Comprehensive Guide?</h1>
              </h1>
        ...
        case "scared-to-fall-in-love":
          return(
            ...
            <article className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-gray-700 mb-4">Aquarians value their independence and freedom above all else. This air sign is known for its unconventional thinking and reluctance to conform to societal norms, including traditional relationships. Aquarians fear losing their individuality and freedom in a committed relationship. They are wary of being tied down and often keep emotions at arm's length to protect their sense of self.</p>
              <h3 className="text-xl font-bold mb-2 text-gray-700">Why They're Scared:</h3>
              <ul className="list-disc list-inside mb-6">
              ...
              <p className="text-lg text-gray-700 mb-4">Understanding the reasons behind these fears can be the first step towards overcoming them. Here are some general tips for each sign to help them open up to love:</p>
              <ul className="list-disc list-inside mb-6">
              ...
              <p className="text-lg text-gray-700">Falling in love can be scary, but it can also be one of the most rewarding experiences. By understanding and addressing their fears, these zodiac signs can learn to embrace love and all the beautiful possibilities it brings.</p>
            </article>
          </div>
          );
